...
function Mens() {
  ...
  const fetchData = useCallback(async () => {
    if (location.pathname === '/page/mens') {
      await axios.get(`/get/all/male`).then((res) => {
        setProducts(res.data);
      });
    } else if (location.pathname === '/page/womens') {
      await axios.get(`/get/all/female`).then((res) => {
        setProducts(res.data);
      });
    } else if (location.pathname === '/page/womens/skirts') {
      await axios.get(`/get/skirt`).then((res) => {
        setProducts(res.data);
      });
    } else if (location.pathname === '/page/womens/jackets') {
      await axios.get(`/get/jacket`).then((res) => {
        setProducts(res.data);
      });
    } else if (location.pathname === '/page/mens/shirts') {
      await axios.get(`/get/shirt`).then((res) => {
        setProducts(res.data);
      });
    } else if (location.pathname === '/page/mens/suits') {
      await axios.get(`/get/suits`).then((res) => {
        setProducts(res.data);
      });
    } else {
