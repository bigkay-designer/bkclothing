...
function ProductDetail() {
  ...
  return (
    <div className="product__detail">
      <div className="back__arrow" onClick={() => locationHistory.goBack()}>
        {' '}
      ...
      <div className="product__container">
        ...
        <div className="price">
          <p>
            £{productDetails.productPrice} <span>VAT included</span>
          </p>
        </div>
        <form onSubmit={addToBasketHandler}>
          ...
          <div className="add__to__cart">
            {!isInCart(product, cart) && (
              <Button className="add__to__cart--btn" type="submit">
            ...
            {isInCart(product, cart) && (
              <div className="add__more__div">
                <Button className="add__to__cart--btn" type="submit">
                  <AddShoppingCart /> add more
                </Button>
                <Button
                  className="to__checkout--btn"
                  onClick={() => locationHistory.push('/checkout')}
                >
                  <AddShoppingCart /> process to checkout
                </Button>
              </div>
            )}
          </div>
